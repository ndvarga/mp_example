...
#directory of file install, buffer length declared as constant
PI = 3.1415926
ESSENCE = os.path.abspath(os.path.join(getsourcefile(lambda:0), os.pardir, os.pardir, os.pardir))
...
def main():
    ...
    while True:
        ...
        lm_list, absolute_pos = tracker.position_finder(image, hand_no = 0)
        print(lm_list)
